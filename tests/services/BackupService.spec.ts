...
describe('BackupService', function () {
  ...
  describe('upload()', function () {
    test('Should upload a backup', async function () {
      respond(http.post('*/api/backups/upload', () => HttpResponse.json({ status: 204 })));
  ...
  describe('delete()', function () {
    test('Should delete a single backup', async function () {
      respond(http.delete('*/api/backups/%40test', () => HttpResponse.json({ status: 204 })));
  ...
  describe('restore()', function () {
    test('Should initialize a backup restore', async function () {
      respond(http.post('*/api/backups/%40test/restore', () => HttpResponse.json({ status: 204 })));
