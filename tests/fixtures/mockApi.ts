...
const pageMatcher: HttpResponseResolver<PathParams, DefaultBodyType, JsonBodyType> = ({
    request,
    params,
}) => {
...
const restHandlers = [
    ...
    http.post("*/api/collections/sub%3D/records", () =>
        HttpResponse.json({ id: "item-post" }),
    ),
    ...
    http.patch("*/api/:collection/abc%3D", () =>
