export declare interface AdminAuthResponse {
    [key: string]: any;
    token: string;
    admin: AdminModel;
}

export declare interface AdminModel extends BaseModel {
    avatar: number;
    email: string;
}

export declare class AdminService extends CrudService<AdminModel> {
    /**
     * @inheritdoc
     */
...
declare interface appleClientSecret {
    secret: string;
}
...
export declare type AsyncClearFunc = () => Promise<void>;

export declare type AsyncSaveFunc = (serializedPayload: string) => Promise<void>;

export declare interface AuthMethodsList {
...
export declare type AuthModel = {
    [key: string]: any;
} | null;

export declare interface AuthOptions extends CommonOptions {
    /**
...
export declare interface AuthProviderInfo {
    name: string;
    displayName: string;
    state: string;
    authUrl: string;
 ...
 */
export declare abstract class BaseAuthStore {
...
export declare interface BeforeSendResult {
    [key: string]: any;
    url?: string;
    options?: {
        [key: string]: any;
...
export declare interface CollectionModel extends BaseModel {
    name: string;
    type: string;
...
export declare interface CommonOptions extends SendOptions {
    fields?: string;
}
...
export declare interface ExternalAuthModel extends BaseModel {
    recordId: string;
    collectionId: string;
    provider: string;
    providerId: string;
...
export declare interface FileOptions extends CommonOptions {
    thumb?: string;
    download?: boolean;
}
...
export declare interface FullListOptions extends ListOptions {
    batch?: number;
}
...
export declare interface HourlyStats {
    total: number;
    date: string;
}
...
export declare interface ListOptions extends CommonOptions {
    page?: number;
    perPage?: number;
    sort?: string;
    filter?: string;
...
export declare interface ListResult<T> {
    page: number;
    perPage: number;
    totalItems: number;
    totalPages: number;
...
export declare interface LogModel extends BaseModel {
    level: string;
    message: string;
    data: {
        [key: string]: any;
...
export declare interface LogStatsOptions extends CommonOptions {
    filter?: string;
}

export declare function normalizeUnknownQueryParams(options?: SendOptions): void;

export declare interface OAuth2AuthConfig extends SendOptions {
    provider: string;
    scopes?: Array<string>;
    createData?: {
        [key: string]: any;
...
export declare type OAuth2UrlCallback = (url: string) => void | Promise<void>;

export declare type OnStoreChangeFunc = (token: string, model: AuthModel) => void;
...
export declare interface RecordAuthResponse<T = RecordModel> {
    /**
...
export declare interface RecordFullListOptions extends FullListOptions, RecordOptions {
}

export declare interface RecordListOptions extends ListOptions, RecordOptions {
}

export declare interface RecordModel extends BaseModel {
    collectionId: string;
...
export declare interface RecordOptions extends CommonOptions {
    expand?: string;
}
...
export declare interface RecordSubscription<T = RecordModel> {
    action: string;
    record: T;
}

export declare interface SchemaField {
    id: string;
    name: string;
    type: string;
    system: boolean;
...
export declare interface SendOptions extends RequestInit {
    [key: string]: any;
    /**
...
export declare type UnsubscribeFunc = () => Promise<void>;
